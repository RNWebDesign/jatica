    ...
    protected function _involveNewCustomer()
    {
        ...
        if ($customer->isConfirmationRequired()) {
            ...
            $this->getCustomerSession()->addSuccess(
                Mage::helper('customer')->__('Account bevestiging is vereist. Believe je email te controlleren en op de bevestigingslink te klikken. Om de bevestigingsmail opnieuw te versturen <a href="%s">klik hier</a>.', $url)
            );
        } else {
